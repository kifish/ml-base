...
# Epoch 149 training loss: 0.29499984558012454, test acc: 0.9664
#reg
reg = 0.001
regularizer = tf.contrib.layers.l2_regularizer(reg)
reg_loss = regularizer(W_1) + regularizer(W_2) + regularizer(W_3)

# Define loss and optimizer
y = tf.placeholder(tf.float32, [None, 10])
loss = tf.reduce_mean(
    tf.nn.softmax_cross_entropy_with_logits(logits=a_3, labels=y)) + reg_loss
