...
# Epoch 149 training loss: 0.1332237864282903, test acc: 0.9158
# Create the model
...
train_step = tf.train.GradientDescentOptimizer(0.01).minimize(loss)#学习率改为0.01；学习率0.001，test_acc最后只到89%左右
